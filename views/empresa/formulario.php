                        ...
                        <fieldset>
                            ...
                            <div class="camposFormulario">
                                <div class="campoContactanos">
                                    ...
                                    <select name="empresa[id_propietario]" id="id_propietario">
                                        <option value="" disabled selected>--Seleccione--</option>
                                        <?php foreach ($propietarios as $propietario) { ?>
                                            <option <?php echo $empresa->id_propietario === $propietario->id ? 'selected' : ''; ?> value="<?php echo s($propietario->id); ?>"> <?php echo s($propietario->nombre . ' ' . $propietario->p_apellido . ' ' . $propietario->s_apellido); ?> </option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="campoContactanos">
